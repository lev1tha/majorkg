...
const COLUMNS = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Жеребьевка составов", href: "/admin/mix" },
    ],
  },
]
        ...
        <div className="grid gap-12 lg:grid-cols-[1.4fr_repeat(3,1fr)]">
          <div className="flex max-w-sm flex-col gap-5">
            ...
            <p className="text-[13.5px] leading-relaxed text-white/40">
              Турнирная инфраструктура для CS2-сцены Кыргызстана и Центральной Азии:
              индивидуальная заявка, жеребьевка составов по рейтингу, автоматическая сетка и
              судейский протокол.
            </p>
