 ...
 */
export function FaqSection({ items }: { items: FaqItemDto[] }) {
  return (
            ...
            <div className="panel rounded-xl border border-white/[0.08] p-6">
              ...
              <div className="mt-3 flex flex-col gap-3 text-[13px] leading-relaxed text-white/45">
                <p>
                  ...
                  Counter-Strike 2, еженедельные лиги и квалификации для игроков из Бишкека, Оша и
                  всей Центральной Азии. Календарь обновляется каждый день, заявка индивидуальная.
                </p>
                <p>
                  Платформа берет на себя рутину организатора: индивидуальные заявки, check-in,
                  жеребьевку составов по рейтингу, автоматическую сетку и протоколы матчей. Игроку
                  остается выбрать турнир и выйти на сервер.
                </p>
              </div>
            </div>
